...
namespace WFA.ECS.Framework.Core.Framework.Interception
{
	public class InvocationContext : IHideBaseTypes
	{
		...
		{
			return this.Invocation.SetArgumentValue(parameterPosition, newValue);
		}
		...
		{
			this.TempData.TryGetValue(name, out var value) ? value : default(object);
